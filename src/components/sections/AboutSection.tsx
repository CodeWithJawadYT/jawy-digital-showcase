...
export function AboutSection() {
  return (
    ...
    >
      ...
      >
        <img src={`${BASE}/moon_icon.11395d36.png`} alt="" loading="lazy" className="w-full" />
      </FadeIn>
      <FadeIn
        delay={0.25}
        x={-80}
      ...
      >
        <img src={`${BASE}/p59_1.4659672e.png`} alt="" loading="lazy" className="w-full" />
      </FadeIn>
      <FadeIn
        delay={0.15}
        x={80}
      ...
      >
        <img src={`${BASE}/lego_icon-1.703bb594.png`} alt="" loading="lazy" className="w-full" />
      </FadeIn>
      <FadeIn
        delay={0.3}
        x={80}
      ...
      >
        <img src={`${BASE}/Group_134-1.2e04f3ce.png`} alt="" loading="lazy" className="w-full" />
      </FadeIn>
      ...
      <div className="relative z-10 flex flex-col items-center gap-16 sm:gap-20 md:gap-24">
        <div className="flex flex-col items-center gap-10 sm:gap-14 md:gap-16">
          ...
          <AnimatedText
            text={aboutText}
            className="max-w-[700px] text-center font-medium leading-relaxed text-[#D7E2EA]"
